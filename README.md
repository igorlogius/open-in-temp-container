...
<ul>
  ...
  <li>
    <b>Auto / Manual Mode + Excepion/Includion List</b>
    You can do either ... either explicetly define a set of URLs that should always be open in a temp container
    or open all URLs with the exception of a defined set of URLs in a temp container
  </li>
</ul>
